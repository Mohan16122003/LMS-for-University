...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($check_email_stmt->num_rows > 0) {
    ...
    $target_dir = "uploads/";
    $profilePicture = "student_" . basename($profilePicture);
    ...
    $stmt = $conn->prepare("INSERT INTO users (Name, Email, PasswordHash, Address, Role, RegistrationNumber, ProfilePicture) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $name, $email, $password, $address, $role, $registrationNumber, $profilePicture);
